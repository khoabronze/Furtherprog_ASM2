...
class InsuranceCardDaoTest {
    ...
    void getAllSuccess() throws SQLException{
        ...
        assertEquals(22, insuranceCards.size());
    }
    @Test
    ...
    @Test
    void getAllInsuranceCardThrowsExceoption() throws SQLException{
        RuntimeException thrown = assertThrows(RuntimeException.class, () -> {
            insuranceCardDao.getAll();
        });
    ...
    void addFail() throws SQLException {
        ...
        insuranceCard.setCardHolder("July");
        insuranceCard.setPolicyOwner("VAT");
        insuranceCard.setExpirationDate("2024-05");
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> {
            insuranceCardDao.add(insuranceCard);
        });
        assertEquals("Not format Date", thrown.getMessage());
    }
    @Test
    ...
    void updateFail() throws SQLException {
        InsuranceCard insuranceCard = new InsuranceCard();
        insuranceCard.setCardNumber(null);
        insuranceCard.setCardHolder("July1");
        insuranceCard.setPolicyOwner("VAT1");
        insuranceCard.setExpirationDate("2024-05");
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> {
            insuranceCardDao.update(insuranceCard.getCardNumber(), insuranceCard.getCardHolder(), insuranceCard.getPolicyOwner(), insuranceCard.getExpirationDate());
        });

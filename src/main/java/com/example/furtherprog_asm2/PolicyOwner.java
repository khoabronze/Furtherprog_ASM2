...
public class PolicyOwner extends User {
    ...
    public PolicyOwner(String id, String name, String phone, String email, String address, String password, InsuranceCard insuranceCard, ArrayList<Object> list, String role, HashMap<Object, Object> map) {

...
public class Navigation_Controller {
    ...
    @FXML
    public void navigateInsuranceCardMenuInsuranceManager() throws IOException {
        // Load the FXML file for the new scene
        Parent newSceneParent = FXMLLoader.load(getClass().getResource("InsuranceCard-Menu-InsuranceManager.fxml"));

        // Create a new scene
        Scene newScene = new Scene(newSceneParent);

        // Get the current stage
        Stage currentStage = (Stage) insurancecardInsuranceManagerIcon.getScene().getWindow();
